                                        ...
                                        <div class="col-sm-auto">
                                            <div>
                                                <button type="button" class="btn btn-success add-btn" id="create-btn"
                                                    onclick="window.location.href='{{ url('admin/add-beauty') }}'">
                                                    ...
                                                    <tr>
                                                        ...
                                                        {{-- <td class="customer_name">
                                                            ...
                                                            <img style="width: 200px; height: 100px;"
                                                                src="{{ asset('beauty_images') }}/{{ $image->image }}">
                                                        </td> --}}
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="d-flex gap-2">
                                                                <div class="edit">
                                                                    <a href="{{ route('beauty.editbeauty', $image->id) }}"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <button onclick="ajaxRequest(this)"
                                                                            data-url="{{ route('beauty.deletebeauty', $image->id) }}"
                                                                            class="btn
                                                                 w-sm btn-danger"

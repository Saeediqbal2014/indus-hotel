...
@section('content')
                        ...
                        <div class="card-body">
                            <div class="listjs-table" id="customerList">
                                ...
                                <div class="table-responsive table-card mt-3 mb-1">
                                    ...
                                    <input type="button" class="btn btn-danger" style="float: right;
                                    margin-right: 27px;" value="Back" onclick="back()">
                                    <input type="button" class="btn btn-primary" style="float: right;
                                    margin-right: 7px;" value="Save Permissiom" onclick="save()">
                                </div>
                            </div>
                        </div><!-- end card -->
                    </div>
    ...
    <script>
         function save(){
            toast('Permission Saved','Success !','success');
            setTimeout(function(){
                window.history.back();
            }, 1500)   
        }

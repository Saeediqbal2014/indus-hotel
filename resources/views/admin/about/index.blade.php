                                        ...
                                        <div class="col-sm-auto">
                                            <div>
                                                {{-- <button type="button" class="btn btn-success add-btn" id="create-btn"
                                                    onclick="window.location.href='{{ url('admin/add-about') }}'">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="customer_name">
                                                            ...
                                                            <img style="width: 200px; height: 100px;"
                                                                src="{{ asset('about_images') }}/{{ $image->image }}">
                                                        </td>
                                                        <td class="customer_name">
                                                            <?php
                                                            $text = $image->text;
                                                            $words = str_word_count($text, 1); // Split the text into an array of words
                                                            $limitedText = implode(' ', array_slice($words, 0, 10)); // Take the first 20 words
                                                            echo $limitedText;
                                                            ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="d-flex gap-2">
                                                                <div class="edit">
                                                                    <a href="{{ route('about.editabout', $image->id) }}"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <button onclick="ajaxRequest(this)"
                                                                            data-url="{{ route('about.deleteabout', $image->id) }}"
                                                                            class="btn
                                                                 w-sm btn-danger"

                                        ...
                                        <div class="col-sm-auto">
                                            <div>
                                                {{-- <button type="button" class="btn btn-success add-btn" id="create-btn"
                                                    onclick="window.location.href='{{ url('admin/add-contact') }}'">
                                            ...
                                            <tbody class="list form-check-all">
                                                @foreach ($contacts as $contact)
                                                    <tr>
                                                        ...
                                                        <td class="customer_name">{{ $contact->name }}
                                                        </td>
                                                        <td class="customer_name">{{ $contact->email }}
                                                        </td>
                                                            ...
                                                            <div class="d-flex gap-2">
                                                                ...
                                                                <div class="remove">
                                                                    <button class="btn btn-sm btn-danger remove-item-btn"
                                                                        ...
                                                                        data-bs-target="#remove_data{{ $contact->id }}">Remove</button>
                                                                </div>
                                                            </div>
                                                        </td>

                                                    </tr>
                                                    <div id="remove_data{{ $contact->id }}" class="modal fade zoomIn"

...
<!-- Mirrored from themesbrand.com/velzon/html/default/apps-email-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Oct 2023 12:36:31 GMT -->
...
<head>
    ...
    <!-- Layout config Js -->
    <script src="{{ asset('front_assets/js/layout.js') }}"></script>
    <!-- Bootstrap Css -->
    <link href="{{ asset('front_assets/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    <link href="{{ asset('front_assets/css/icons.min.css') }}" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="{{ asset('front_assets/css/app.min.css') }}" rel="stylesheet" type="text/css" />
    <!-- custom Css-->
    <link href="{{ asset('front_assets/css/custom.min.css') }}" rel="stylesheet" type="text/css" />
...
<body>
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr
                                                                ...
                                                                <td class="content-block"
                                                                    ...
                                                                    valign="top">
                                                                    <div
                                                                        style="margin-bottom: 15px; margin-left: 150px;">
                                                                        <img src="https://www.indushotel.com/demo/public/front_assets/images/logo.png"
                                                                            alt="" height="123"
                                                                            width="200">
                                                                    </div>
                                                                </td>
    ...
    <!-- JAVASCRIPT -->
    <script src="{{ 'front_assets/libs/bootstrap/js/bootstrap.bundle.min.js' }}"></script>
    <script src="{{ 'front_assets/libs/simplebar/simplebar.min.js' }}"></script>
    <script src="{{ 'front_assets/libs/node-waves/waves.min.js' }}"></script>
    <script src="{{ 'front_assets/libs/feather-icons/feather.min.js' }}"></script>
    <script src="{{ 'front_assets/js/pages/plugins/lord-icon-2.1.0.js' }}"></script>

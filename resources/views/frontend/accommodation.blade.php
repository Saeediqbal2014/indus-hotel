                        ...
                        <div class="row">
                            <div class="content-column col-lg-4 col-md-6 col-sm-12">
                                <div class="inner-column wow fadeInLeft">
                                    <span class="aroom-sub-title">Deluxe King</span>
                                    <!-- <sup>PKR</sup>
                                    ...
                                    <a href="room-deluxe-king.php" class="book-now">Discover More</a>
                                </div>
                            </div>
                            <div class="image-column col-lg-8 col-md-6 col-sm-12">
                                <div class="image-box">
                                    <figure class="image wow fadeInUp">
                                        <img src="{{ asset('front_assets/images/room/deluxe/deluxe1.jpg') }}"
                                            alt="">
                                    </figure>
                                </div>
                            </div>

            ...
            <div class="row">
                    ...
                    <div class="inner-box wow fadeInLeft" data-wow-delay="200ms">
                        <div class="image-box">
                            <figure class="image overlay-anim">
                                ...
                                <a href="{{ asset('front_assets/images/hall/crystal3.jpg') }}" class="dis_no"
                                    data-lightbox="crystal">
                                    <img src="{{ asset('front_assets/images/hall/crystal3.jpg') }}" alt=""></a>
                                <a href="{{ asset('front_assets/images/hall/crystal4.jpg') }}" class="dis_no"
                                    data-lightbox="crystal">
                                    <img src="{{ asset('front_assets/images/hall/crystal4.jpg') }}" alt=""></a>
                                <a href="{{ asset('front_assets/images/hall/crystal5.jpg') }}" class="dis_no"
                                    data-lightbox="crystal">
                                    <img src="{{ asset('front_assets/images/hall/crystal5.jpg') }}" alt=""></a>
                                <a href="{{ asset('front_assets/images/hall/crystal6.jpg') }}" class="dis_no"
                                    data-lightbox="crystal">
                                    <img src="images/hall/crystal6.jpg" alt=""></a>
                                <a href="{{ asset('front_assets/images/hall/crystal7.jpg') }}" class="dis_no"
                                    data-lightbox="crystal">
                                    <img src="{{ asset('front_assets/images/hall/crystal7.jpg') }}" alt=""></a>
                                <a href="{{ asset('front_assets/images/hall/crystal8.jpg') }}" class="dis_no"
                                    data-lightbox="crystal">
                                    <img src="{{ asset('front_assets/images/hall/crystal8.jpg') }}" alt=""></a>
                            </figure>
                            <!-- <span class="date">DEC<br><small>20</small></span> -->
                        </div>
                        <div class="content-box">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="200ms">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="300ms">
                        <div class="image-box">
                            <figure class="image overlay-anim">
                                <a href="images/hall/daimond1.jpg" data-lightbox="daimond">
                                    <img src="{{ asset('front_assets/images/hall/daimond1.jpg') }}" alt=""></a>
                                <a href="{{ asset('front_assets/images/hall/daimond2.jpg') }}" class="dis_no"
                                    data-lightbox="daimond">
                                    <img src="{{ asset('front_assets/images/hall/daimond2.jpg') }}" alt=""></a>
                                <a href="{{ asset('front_assets/images/hall/daimond3.jpg') }}" class="dis_no"
                                    data-lightbox="daimond">
                                    <img src="{{ asset('front_assets/images/hall/daimond3.jpg') }}" alt=""></a>
                            </figure>
                            <!-- <span class="date">DEC<br><small>20</small></span> -->
                        </div>
                        <div class="content-box">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms">
                    <div class="inner-box wow fadeInLeft">
                        <div class="image-box">
                            <figure class="image overlay-anim">
                                <a href="images/hall/pearl1.jpg" data-lightbox="pearl">
                                    <img src="{{ asset('front_assets/images/hall/pearl1.jpg') }}" alt=""></a>
                                <a href="images/hall/pearl2.jpg')}}" class="dis_no" data-lightbox="pearl">
                                    <img src="{{ asset('front_assets/images/hall/pearl2.jpg') }}" alt=""></a>
                            </figure>
                            <!-- <span class="date">DEC<br><small>20</small></span> -->
                        </div>
                        <div class="content-box">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="200ms">
                        <div class="image-box">
                            <figure class="image overlay-anim">
                                <a href="images/hall/marvi_hall.jpg" data-lightbox="marvi_hall">
                                    <img src="images/hall/marvi_hall.jpg" alt=""></a>
                                <a href="images/hall/marvi.jpg" class="dis_no" data-lightbox="marvi_hall">
                                    <img src="images/hall/marvi.jpg" alt=""></a>
                            </figure>
                            <!-- <span class="date">DEC<br><small>20</small></span> -->
                        </div>
                        <div class="content-box">
                            ...
                            <div class="hall_facilities">
                                <ul class="post-info">
                                    <li><img src="images/hall/icon/banquet.png" class="img_icon"><span
                                            class="area-size-span">BANQUET</span></li>
                                    <li><i class="fa-solid fa-bell-concierge"></i><span
                                            class="area-size-span">RECEPTION</span></li>
                                    <!-- <li><i class="fa-solid fa-ruler-triangle"></i><span class="area-size-span">THEATRE</span></li> -->
                                    <li><i class="fa-regular fa-tablet-rugged"></i><span
                            ...
                            <div class="hall_facilities">
                                <ul class="post-info">
                                    <li><img src="images/hall/icon/conferance.png" class="img_icon"><span
                                            class="area-size-span">CONFERANCE</span></li>
                                    <li><i class="fa-regular fa-screen-users"></i><span
                                            class="area-size-span">CLASSROOM</span></li>
                                    <!-- <li><i class="fa-solid fa-ruler-triangle"></i><span class="area-size-span">THEATRE</span></li> -->
                                    <li><img src="images/hall/icon/boardroom.png" class="img_icon"><span
                                            class="area-size-span">BOARDROOM</span></li>
                                </ul>
                            </div>
                            <a href="contact.php" class="read-more" data-bs-toggle="modal"
                                data-bs-target="#exampleModal">Reserve Now<i class="fa-solid fa-arrow-right"></i></a>
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="500ms">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="300ms">
                        <div class="image-box">
                            <figure class="image overlay-anim">
                                <a href="images/hall/jasmin_hall.jpg" data-lightbox="jasmine_hall">
                                    <img src="images/hall/jasmin_hall.jpg" alt=""></a>
                            </figure>
                            <!-- <span class="date">DEC<br><small>20</small></span> -->
                        </div>
                        <div class="content-box">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="500ms">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="300ms">
                        <div class="image-box">
                            <figure class="image overlay-anim">
                                <a href="images/hall/conferance_room1.jpg" data-lightbox="conference_room">
                                    <img src="images/hall/conferance_room1.jpg" alt=""></a>
                                <a href="images/hall/conferance_room2.jpg" class="dis_no"
                                    data-lightbox="conference_room">
                                    <img src="images/hall/conferance_room2.jpg" alt=""></a>
                                <a href="images/hall/conferance_room3.jpg" class="dis_no"
                                    data-lightbox="conference_room">
                                    <img src="images/hall/conferance_room3.jpg" alt=""></a>
                            </figure>
                            <!-- <span class="date">DEC<br><small>20</small></span> -->
                        </div>
                        <div class="content-box">
                            ...
                            <div class="hall_facilities">
                                <ul class="post-info">
                                    <li><img src="images/hall/icon/meeting_room.png" class="img_icon"><span
                                            class="area-size-span">MEETING ROOM</span></li>
                                    <li><i class="fa-solid fa-bell-concierge"></i><span
                                            class="area-size-span">RECEPTION</span></li>
                                    <!-- <li><i class="fa-solid fa-ruler-triangle"></i><span class="area-size-span">THEATRE</span></li> -->
                                    <li><i class="fa-regular fa-tablet-rugged"></i><span
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="500ms">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="300ms">
                        <div class="image-box">
                            <figure class="image overlay-anim">
                                <a href="images/hall/committe_room.jpg" data-lightbox="committe">
                                    <img src="images/hall/committe_room.jpg" alt=""></a>
                            </figure>
                            <!-- <span class="date">DEC<br><small>20</small></span> -->
                        </div>
                        <div class="content-box">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="500ms">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="300ms">
                        <div class="image-box">
                            <figure class="image overlay-anim">
                                <a href="images/hall/senate1.jpg" data-lightbox="senate">
                                    <img src="images/hall/senate1.jpg" alt=""></a>
                                <a href="images/hall/senate2.jpg" class="dis_no" data-lightbox="senate">
                                    <img src="images/hall/senate2.jpg" alt=""></a>
                                <a href="images/hall/senate3.jpg" class="dis_no" data-lightbox="senate">
                                    <img src="images/hall/senate3.jpg" alt=""></a>
                                <a href="images/hall/senate4.jpg" class="dis_no" data-lightbox="senate">
                                    <img src="images/hall/senate4.jpg" alt=""></a>
                            </figure>
                            <!-- <span class="date">DEC<br><small>20</small></span> -->
                        </div>
                        <div class="content-box">

                ...
                <div class="content-column col-xl-6 col-lg-6 order-lg-2 wow fadeInRight" data-wow-delay="600ms">
                    <div class="inner-column">
                        <div class="sec-title">
                            ...
                            <h2>Vision Behind Indus Hotel Legacy</h2>
                            <div class="text">Hotel Logo is Blind Dolphin, as Blind Dolphin is found only in Indus River,
                                ...
                                time to time. In fact, it is the only best hotel in the entire province of Sindh other than
                                Karachi.</div>
                        </div>
                        <div class="btn-box">
                ...
                <div class="image-column col-xl-6 col-lg-6">
                    <div class="inner-column wow fadeInLeft">
                        ...
                        <figure class="image-2 overlay-anim wow fadeInLeft">
                            <img src="{{ asset('front_assets/images/indus_dolphine.jpeg') }}" width="291" alt="">
                        </figure>
                        <div class="btn-box">
                            <a href="{{ asset('front_assets/video/indus_vid2.mp4') }}" class="play-now-two"
                        ...
                        <div class="exp-box bounce-y">
                            <figure class=" overlay-anim wow fadeInLeft">
                                <img src="{{ asset('front_assets/images/logo.png') }}" style="max-width:200px;"
                                    alt="">
                            </figure>
